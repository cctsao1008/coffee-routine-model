...
from tiny_tools.visualize import STATE_KEYS, paint_coffee_year
...
def test_tiny_painter_makes_every_promised_picture(tmp_path):
    ...
    with output_csv.open("w", encoding="utf-8", newline="") as f:
        ...
        for day, mode in enumerate(("Normal", "Busy", "Recovery", "Special"), 1):
            row = {"sample_id": day, "true_mode": mode, "estimated_mode": mode,
                   "ESS": 250.0 + day, "true_R": 0.70 + day * 0.01,
                   "est_R": 0.69 + day * 0.01}
            for state in STATE_KEYS:
    ...
    assert names == {
        "state-P.png", "state-M.png", "state-V.png", "state-C.png",
        "state-E.png", "state-F.png", "modes.png", "ess.png", "tiny-year-summary.png",
    }
